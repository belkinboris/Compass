...
def test_post_attaches_buyer_detail_only_alongside_the_buyer_name():
    ...
    из `eco.context` законно идёт довеском через тире, как и раньше."""
    deal = {
    ...
    assert "Покупатель: «Ромашка» — «Ромашка» — крупный региональный девелопер" in text
...
def test_post_buyer_detail_requires_a_sentence_about_the_buyer_itself():
    ...
    assert "Покупатель: Иван Тырышкин — Иван Тырышкин ранее возглавлял" in text_ok
