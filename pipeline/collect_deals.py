...
СТИЛЬ: пиши простым профессиональным русским языком. Не начинай поля словами «Сделка:», «В рамках сделки», «Таким образом» или «Данная сделка». Не повторяй один факт в нескольких полях. Не используй общие фразы без фактов.
