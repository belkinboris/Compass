...
def render(base, year, month):
    ...
    lines.append('')
    # «#итогимесяца» партнёр (7 сентября 2026) предложила заменить на
    # «#статистика»: по этому слову сводку ищут, а «итоги месяца» — наш
    # внутренний ярлык рубрики.
    lines.append('#статистика #MA')
    return '\n'.join(lines)
