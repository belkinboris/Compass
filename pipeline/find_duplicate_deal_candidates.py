...
NOT_DUPLICATES = {
    ...
    frozenset({'g7b4be1c4', 'ga7298401'}): '«Медскан»: предложение Харитонина и привлечение перед IPO',
    frozenset({'ga7298401', 'gc9461b5c'}): '«Медскан»: привлечение перед IPO и выход Сбербанк Инвестиций',
