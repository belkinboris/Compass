...
OVERRIDES = {
    ...
    # Альфа-банк, А1 и «Альфа-Капитал» запускают ЗПИФ «специальных ситуаций» на
    # 30 млрд ₽ — объём фонда, который планируют собрать, а не цена покупки;
    # по тексту («30 млрд ₽») правило считало это ценой (третий разбор рецензента)
    'gf14ff7aa': ('30 млрд ₽', 'raise'),
}
