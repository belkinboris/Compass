...
Проверено на всех 91 месте, где поле начинается с «<что-то> — <Заглавная>»:
правило срезает 40, ещё 4 разобраны руками (см. MANUAL), и 47 оставлено —
все 47 действительно тире как знак препинания. Итого 44 поля у 23 карточек.
