...
карточка идёт в базу, только если у неё есть покупатель, предмет и отрасль.
Замер на потоке 4 августа: из 44 черновиков автоматически прошли 5, и все пять
— настоящие сделки. Остальные 39 ушли человеку с причиной.
