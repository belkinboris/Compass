...
# Мера тела статьи. Медиана полного текста — 6,4 тыс. знаков, 90-й процентиль
# около 15 тыс.; всё, что длиннее, — почти всегда лента новостей, приклеенная
# к статье, а не сама статья.
LIMIT = 14000
