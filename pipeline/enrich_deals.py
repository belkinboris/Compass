...
Верни СТРОГО JSON, без пояснений и markdown-ограждений:
{
  ...
  "industry": "одна отрасль из списка: Нефть и газ, Уголь, ГМК и добыча, Энергетика, Химия и удобрения, Агро, Пищепром и напитки, Ритейл, E-commerce, Потребительские товары, ИТ и интернет, Искусственный интеллект, Телеком, Банки, Страхование, Финтех, Финансовые услуги, Рынок ценных бумаг, Управление активами, Холдинги, Транспорт и логистика, Порты и инфраструктура, Автопром, Недвижимость, Строительство, Гостиницы и туризм, Здравоохранение, Фармацевтика, Образование, Развлечения, Профессиональные услуги, Медиа, Машиностроение, Лесопром, ЖКХ и обращение с отходами, Не определена",
...
- Пиши коротко и по-русски: без «данная сделка», «в рамках сделки», «таким образом», «представляет собой» и других шаблонных связок.
- Не начинай extra_details с «Сделка:» и не повторяй сведения, уже вынесенные в сумму, стороны или консультантов."""
