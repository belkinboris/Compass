...
Запускает его ОТДЕЛЬНЫЙ ежедневный триггер `trig_01MsQsKqmZoqhZknigXNPZDC`
(08:25 МСК): встроить шаг в существующую рутину «качество» не вышло —
`update_trigger` не редактирует промпт триггера, привязанного к чужой
сессии (см. `COMPANY_FINANCE_BRIEF.md`, этап 6, П3-6). Дешёвую проверку
«есть ли новые данные» не жалко запускать и чаще.
