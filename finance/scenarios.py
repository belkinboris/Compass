...
print()
print("  45 000 ₽ ПРОХОДЯТ при темпе 2 договора в месяц: минимальная цена при")
print("  этом темпе — 43 300 ₽, то есть у вашей цены есть небольшой запас.")
print("  Со страховкой на три месяца нужен темп 2,3 в месяц или цена 50 900 ₽.")
print()
print("  И то же, что было видно раньше: без разработчика 45 000 ₽ хватает")
print("  при темпе 0,2–0,4 договора в месяц. Решается не цена Pro, а то,")
